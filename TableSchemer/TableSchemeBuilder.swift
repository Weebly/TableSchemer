...
public final class TableSchemeBuilder {
    ...
    /**  
     ...
     - parameter     handler:   The block to configure the builder.
     - returns:                 The created SchemeSet object.
    */
    @discardableResult public func buildSchemeSet(_ handler: (_ builder: SchemeSetBuilder) -> Void) -> SchemeSet {
